...
import com.zhitao.train.business.service.DailyTrainService;
...
public class DailyTrainAdminController {
    ...
    public CommonResp<Object> genDaily(@PathVariable @DateTimeFormat(pattern = "yyyy-MM-dd") LocalDate date) {
